...
import { PasswordForm } from '@/app/lib/definitions';
import {
  CheckIcon,
  ClockIcon,
  CurrencyDollarIcon,
...
import { updatePassword, State } from '@/app/lib/actions';
...
export default function EditPasswordForm({
  ...
  const updatePasswordWithId = updatePassword.bind(password.id, PasswordForm);
